...
/**
 * Provides the contents for the suggestion drop-down list.in {@link MySearchView}.
 */
public class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    private final MySearchView mSearchView;
    ...
    public SuggestionsAdapter(Context context, MySearchView searchView, SearchableInfo searchable,
