...
public class RadioImageGroup extends LinearLayout {
    ...
    public RadioImageGroup(Context context, AttributeSet attrs) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(
                attrs, R.styleable.RadioImageGroup);

        int value = attributes.getResourceId(R.styleable.RadioImageGroup_checkedButton, View.NO_ID);
        if (value != View.NO_ID) {
            mCheckedId = value;
        }
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        if (child instanceof RadioImageButton) {
            final RadioImageButton button = (RadioImageButton) child;
            if (button.isChecked()) {
                mProtectFromCheckedChange = true;
                if (mCheckedId != -1) {
    ...
    private void setCheckedStateForView(int viewId, boolean checked) {
        ...
        if (checkedView != null && checkedView instanceof RadioImageButton) {
            ((RadioImageButton) checkedView).setChecked(checked);
        }
    }
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new RadioImageGroup.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof RadioImageGroup.LayoutParams;
    }
    ...
    public CharSequence getAccessibilityClassName() {
        return RadioImageGroup.class.getName();
    }
